...
This repo provides more detail information for https://doi.org/10.1101/2020.02.03.933069. ["Genomic analyses reveal the origin of domestic ducks and identify different genetic underpinnings of wild ducks"](manuscript/MS%20for%20genome%20biology%20clean.pdf) that was rejected previously due to [a reviewer claims that our findings have been reported in somewhere else for one reason, which is not true and they published later than ours preprint version](manuscript/point%20to%20point%20file%20GBIO.pdf).  I submitted an appeal and answered all the comments in the point-to-point file but received no response.
So here I made a short declaration.   
The core analyses and conclusions presented in this repository were completed several years prior to the appearance of a the later publication reporting highly similar findings on the evolutionary history of domestic and wild ducks, which was used by the third reviewer to [reject our submission](manuscript/point%20to%20point%20file%20GBIO.pdf). Due to prolonged delays and unsuccessful attempts at formal publication, these results were not disseminated through traditional journal channels at the time.

To ensure transparency and proper documentation of the original analytical framework, assumptions, and timelines, I have made the full analyses and results available here. I welcome careful methodological comparison and independent evaluation of these findings.

The core results presented in Guo's paper, which [the third reviewer relied on as the basis for rejecting our submission](manuscript/point%20to%20point%20file%20GBIO.pdf)—and which I believe were authored by the reviewer— had in fact been obtained by us at least four years earlier, were first documented in my [PHD thesis](manuscript/基于基因组学的鸭进化及驯化分析-定稿.pdf) in chinese in 2017, and were posted on bioRxiv in 2020 February, ahead of his publication(2020 November). This scintific question is chanllange especially when I was assigned to start this project with limited conditions. After I committed huge and finially made those interesting findings, my further investigation and the writing and publication process have been hindered by my limited englishe skill, endless writing authority and communiction structure problems. witnessing those precious time periods being missed, even while knowing this would cause irreversible consequences, now I may no longer have the chance to publish the work and further the exploration, though I finally domaniated the writing and remove those unrelated contents such as avian flu and finily enther the "under review" process in ME 2019 and almost success in recent BMC submission using my part time. I was unaware that my administrator had lanuched a new research related to this work until some misunderstandings with journal hindered my publication again. decad efforts I was still unable to live up to the support from many people, escpcially my first supervisor and the group as acknowledged in the paper.    
...
### As we mentioned in recent version that submitted to BMC, we've replicated most analyses on the newly widely used reference ZJU1 and included more recently published duck WGS data to confirm our results. 
...
[All my illustration in my github repos are unofficial discussion and are not publication media. I could modifed or delete if someone care about.](https://github.com/ruiliuacd/MathPracticeNote/blob/main/Dstatistic.ipynb)
