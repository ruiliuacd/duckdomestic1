...
The core results presented in the paper, [which was used by the third reviewer to reject our submission](manuscript/point%20to%20point%20file%20GBIO.pdf)—and which I believe were authored by the reviewer— were results that we had reached at least four years before his publications (2020) and first documented in my PHD thesis in chinese in 2017 and post to bioarxiv in 2020. This scintific question is chanllange especially when I was assigned to start this project with limited conditions. Though I'd commit huge resource and finially made those interesting findings under the supervision of my new administrator, I not fully trusted or supported by my administrator (so she's considering continued things according my results and I don't have the permission to transfer or submit to low IF journals due to my respect to her) and couldn't smoothly obtain permission to efficiently work on publication and further the research after those findings. So the first "under review" process dominated by me was the submission to ME 2019, in which the avian-flu-oriented content was corrected and removed. While I even unaware that my administrator was starting a new research project related to this work and finially cause some misunderstandings during the review process with conmunication with editors in the last submission.  
...
| 3 | genome biology | negtive | `DO NOT enjoy reading` `difficult to pinpoint how this work has any advanced` | four months for review and subsequenced appeal with no response|
